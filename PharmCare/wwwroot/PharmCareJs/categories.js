...
$("#btnSubmit").click(function () {
    ...
    var formData = new FormData($('#frmAddCategory').get(0));

    $.ajax({
        type: "POST",
        url: "/Admin/Categories/Create", // NB: Use the correct action name
        data: formData,
        dataType: 'json',
        contentType: false,
        processData: false,
...
$("#btnUpdate").click(function () {
    ...
    $.ajax({
        type: "POST",
        url: "/Admin/Categories/Update", // NB: Use the correct action name
        data: formData,
        dataType: 'json',
        contentType: false,
        processData: false,
...
function GetRecord(e) {
    ...
    $.get("/Admin/Categories/GetById/?Id=" + id, function (data, status) {
        ...
        if (data == null) {
            ...
            $('#ModalUpdateCategory').modal({ backdrop: 'static', keyboard: false })
